...
<div class="slider_area">
    <div class="slider_active owl-carousel">
        <!-- single_carouse -->
        <div class="single_slider d-flex align-items-center" style="background: url('assets/images/3.jpeg') no-repeat center center/cover; height: 500px; ">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-12">
                    ...
                    <div class="single__news">
                        <div class="thumb">
                            <a href="<?php echo site_url('artikel/' . $row->tulisan_slug); ?>">
                                <img src="<?php echo base_url() . 'assets/images/3.jpeg' . $row->tulisan_gambar; ?>" alt="<?php echo $row->tulisan_judul; ?>">
                            </a>
