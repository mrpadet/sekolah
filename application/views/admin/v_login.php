            ...
            <div class="row">
              <div class="p-3">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Sistem Informasi Sekolah MTsS Darul Ulum Budi Agung</h1>
                  </div>
                  ...
                  <form action="<?php echo site_url().'admin/login/auth'?>" method="post">
                    <div class="form-group">
                      <input type="text" name="username" class="form-control form-control-user" aria-describedby="emailHelp" placeholder="Username" value="admin" autocomplete="off">
                    </div>
                    <div class="form-group">
                      <input type="password" name="password" class="form-control form-control-user" id="exampleInputPassword" placeholder="Password" value="admin">
                    </div>
